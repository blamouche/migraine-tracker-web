...
**Critères d'acceptation :**
- [ ] L'écran de login affiche les 3 boutons sociaux (Google, Apple, Facebook) et un séparateur « ou »
- [ ] Le flux OAuth redirige vers le provider et retourne dans l'app après succès
- [ ] Si la popup est bloquée, un message explicite invite à l'autoriser
- [ ] Si l'utilisateur annule, retour à l'écran de login sans message d'erreur
...
**Critères d'acceptation :**
- [ ] Formulaire email + mot de passe (≥ 8 caractères)
- [ ] Email de confirmation envoyé après inscription
- [ ] Le compte n'est activé qu'après clic sur le lien de confirmation
...
**Critères d'acceptation :**
- [ ] L'utilisateur saisit son email, reçoit un lien valide 15 minutes
- [ ] Si le lien est expiré, message clair avec bouton « Renvoyer »
...
**Critères d'acceptation :**
- [ ] Un UUID anonyme est généré et stocké en IndexedDB
- [ ] Un message non-bloquant explique que le compte sera créé à la prochaine connexion
- [ ] Toutes les fonctionnalités gratuites sont accessibles
- [ ] À la prochaine session connectée, le flow de login s'affiche automatiquement
- [ ] Les métriques d'usage pré-auth sont conservées après merge du compte
...
**Critères d'acceptation :**
- [ ] Le token Supabase (30 jours) est vérifié au démarrage
- [ ] Si valide : chargement direct, sans écran de login
- [ ] Si expiré et connecté : renouvellement silencieux
- [ ] Si expiré et hors ligne : l'app fonctionne normalement en mode local
...
**Critères d'acceptation :**
- [ ] Une explication en une phrase précède le sélecteur de dossier
- [ ] L'app crée la structure `Migraine AI/` si le dossier est vide
- [ ] L'app reconnaît et charge un vault existant
- [ ] La permission FSAPI est mémorisée par Chrome pour les sessions suivantes
...
**Critères d'acceptation :**
- [ ] Deux cases distinctes : CGU (obligatoire) et marketing (optionnel, décochée par défaut)
- [ ] L'inscription est impossible sans acceptation des CGU
- [ ] Le consentement marketing est horodaté et stocké dans Supabase
...
**Critères d'acceptation :**
- [ ] 3 champs seulement : type de migraine, traitement de crise habituel, traitement de fond
- [ ] Champs optionnels — bouton « Passer pour l'instant » visible
- [ ] Un message invite à compléter le profil dans les préférences ultérieurement
...
*Fin du backlog v1.0 — 147 User Stories réparties en 22 Epics*
